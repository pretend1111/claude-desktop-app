...
// Made flatter: 22 width, 14 height. Stroke width 1.5 to match others.
...
// The specific "Projects" tray icon
export const IconProjects = ({ size = 20, className = "" }: { size?: number, className?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M3 7v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V7" />
    <path d="M14.5 9.5L12 12L9.5 9.5" />
    <line x1="12" y1="12" x2="12" y2="3" />
    <path d="M3 7H21" />
  </svg>
);

// The "Artifacts" icon (Shapes)
export const IconArtifacts = ({ size = 20, className = "" }: { size?: number, className?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 2L15 8L21 8L16.5 12.5L18 19L12 15.5L6 19L7.5 12.5L3 8L9 8L12 2Z" transform="scale(0.8) translate(3,3)" />
...
export const IconArtifactsExact = ({ size = 20, className = "" }: { size?: number, className?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={className}>
     <path d="M6 8L8 4L10 8L14 8L11 11L12 15L8 12.5L4 15L5 11L2 8H6Z" />
